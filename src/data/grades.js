...
export const gradeDescriptions = {
  [grades.ANALYST_DEVELOPER]: [
    ...
    "You are expected to learn quickly, to keep an open mind, to ask for help constructively, and to contribute where you can.\nYou are part of a formal traineeship programme that aims to teach you how to be an effective consultant and a good developer.This typically lasts two years. ",
  ...
  [grades.DEVELOPER]: [
    "You are no longer a trainee, but that doesn't mean you've stopped learning. You have useful, core skills in one or more technologies that you can apply in a project context, and you are starting to move beyond the precise practices you were taught, gaining a better understanding of the underlying principles that make them work."
  ],
  [grades.SENIOR_DEVELOPER]: [
