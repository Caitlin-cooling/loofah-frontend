    ...
    <MainWrapper>
      ...
      <List>
        ...
        <ListItem className={`${classes.listItem} MuiTypography-body1`}>
          ...
          to get a more detailed picture of the technical and soft skills you
          should be developing day to day, and how you might go about doing
          that.
        </ListItem>
      </List>
      ...
      <Typography variant="body1">
        Engineering Skills are grouped into 7 categories: leadership,
        collaboration, delivery, technical, software design and security.
      </Typography>
      <Typography variant="body1">
        Each skill is positioned as a headline capability, with some prompting
        questions, designed to help you assess whether you are operating at the
        target level. The questions are not an exhaustive list of all the things
        you need to cover to meet a capability, nor should they be seen as a
        list of tick box items. Please use them as a guide, rather than a to do
        list.
      </Typography>
      <Typography variant="body1">
        Skills are described in quite some detail at junior grades. For
        ...
        values. Skills become a little broader as grades become more senior, in
        recognition that roles at these levels are likely to be more fluid and
        varied.
      </Typography>
      <Typography variant="body1">
        Where applicable, skills include recommended learning resources, to help
        you grow in the right direction. If you’ve come across resources you
        think we should add, please get in touch.
      </Typography>
      <Typography variant="h3" className={classes.subHeading}>
        Crafting your own learning journey
      </Typography>
      <Typography variant="body1">
        Skills can be filtered by craft, so you can focus on your personal
      ...
      <Typography variant="body1" className={classes.paragraph}>
        Skills are viewed by grade. Grades build upon each other. If you are at
        a more senior grade, we expect you still to be demonstrating the
      ...
      <Typography variant="body1">
        ...
        given skill, it&apos;s a good idea to seek external feedback from people
        you work with day to day. Hopefully this tool gives you a good place to
        start during those conversations.
      </Typography>
      <Typography variant="h3" className={classes.subHeading}>
        Learning as we go
      </Typography>
