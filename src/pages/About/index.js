        ...
        <div className={classes.root}>
            <main className={classes.content}>
                ...
                <Typography variant="body1">
                    ...
                    expected of you as an engineer at Deloitte Digital, as you progress through the organisation.
                </Typography>
                ...
                <Typography variant="body1">
                    Each capability is positioned as a headline skill, with some example behaviours or topics. The
                    detail is there to illustrate the headline capability, so you can assess whether you are operating
                    at the target level. It is not an exhaustive list of all the things you need to cover to meet a
                    capability, nor should it be seen as a list of tick box items. Please use the detail as a guide,
                    rather than a to do list.
                </Typography>
                <Typography variant="body1">
                    Capabilities are described in quite some detail at junior grades. For early-stage engineers, we feel
                    that more thorough guidance is helpful in setting up strong engineering foundations that align to
                    Deloitte’s core values. Capabilities become a little broader as grades become more senior, in
                    recognition that roles at these levels are likely to be more fluid and varied.
                </Typography>
                <Typography variant="body1">
                    Where applicable, capabilities include recommended learning resources, to help you grow in the right
                ...
                <Typography variant="body1">
                    Capabilities can be filtered by craft, so you can focus on your personal area(s) of interest. Along
                ...
                <Typography variant="body1" className={classes.paragraph}>
                    Capabilities are viewed by grade. Grades build upon each other. If you are at a more senior grade,
                ...
                <Typography variant="body1">
                    If you are finding it hard to assess where you&apos;re at against a given capability, it&apos;s
