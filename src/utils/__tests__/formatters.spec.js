import { groupSkillsByCategory } from "../formatters";
import { exampleListSkillsApiResponse } from "../__testData__/skill.data.js";

describe("formatters.groupSkillsByCategory", () => {
  it("returns null if no skills are passed in", () => {
    expect(groupSkillsByCategory()).toEqual(null);
  });

  it("returns correctly grouped skills", () => {
    const result = groupSkillsByCategory(exampleListSkillsApiResponse.data.listSkills);
